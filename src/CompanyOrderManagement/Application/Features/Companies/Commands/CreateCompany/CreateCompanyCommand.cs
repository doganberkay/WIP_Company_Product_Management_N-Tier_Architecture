...
{
    public partial class CreateCompanyCommand:IRequest<CreatedCompanyDto>
    {
        ...
        public class CreateCompanyCommandHandler : IRequestHandler<CreateCompanyCommand, CreatedCompanyDto>
        {
            ...
            {
                await _companyBusinessRules.CompanyNameCanNotBeDuplicatedWhenInserted(request.CompanyName);
